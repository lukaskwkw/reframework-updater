...
use crate::tomlConf::configStruct::{Main, GameConfig, Runtime};

use super::{configStruct::REvilConfig, utils::{serialize, deserialize}};
...
fn serialize_test() {
    ...
    let conf = REvilConfig { main: main_test, games: games_test };
